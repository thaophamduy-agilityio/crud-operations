...
interface BreadCrumbProps {
  ...
  numberOfBook: number | undefined;
}

const BreadCrumb = ({ selectedCategory, numberOfBook }: BreadCrumbProps) => {
  return (
    <div className="book-title">
      ...
      <span className="book-title-results">Showing {numberOfBook} Result(s)</span>
    </div>
  );
};
